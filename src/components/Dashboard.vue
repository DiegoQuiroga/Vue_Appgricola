...
export default {
    ...
    methods:{
        ...
        botoneliminar(correoeliminar){
            ...
            var data = {
                ...
                axios.post('http://localhost:3000/setusuarios/eliminar',data)
                .then(res=>{
                //this.usuarios=res.data
    ...
    mounted(){
        ...
        axios.post('http://localhost:3000/getusuario',data)
        .then(res=>{
            ...
            axios.post('http://localhost:3000/getrol',data)
        .then(res=>{
            ...
            axios.post('http://localhost:3000/getproducto',data)
        .then(res=>{
